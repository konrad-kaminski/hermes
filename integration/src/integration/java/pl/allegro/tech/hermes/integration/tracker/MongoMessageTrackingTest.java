...
public class MongoMessageTrackingTest extends IntegrationTest {
    ...
    public void shouldLogBatchIdInMessageTrace() {
        ...
        SubscriptionPolicy subscriptionPolicy = subscriptionPolicy()
    ...
    public void shouldLogBatchInflightAndSending() {
        ...
        SubscriptionPolicy subscriptionPolicy = singleMessageBatchPolicy();
    ...
    private SubscriptionPolicy singleMessageBatchPolicy() {
